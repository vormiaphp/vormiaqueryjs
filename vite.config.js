  ...
  build: {
    lib: {
      entry: {
        ...
        'adapters/react': resolve(__dirname, 'src/adapters/react/useVormiaQuery.js'),
        'adapters/svelte': resolve(__dirname, 'src/adapters/svelte/vormiaStore.js'),
        'adapters/solid': resolve(__dirname, 'src/adapters/solid/createVormiaResource.js'),
