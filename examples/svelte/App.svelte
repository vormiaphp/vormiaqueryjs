          ...
          <div class="mt-2">
            <div class="p-4 bg-red-50 border border-red-200 rounded-lg">
              <div class="flex items-center">
                ...
                <button on:click={() => clearFieldError('name')} class="ml-auto text-red-400 hover:text-red-600">
                  ✕
                </button>
              </div>
            </div>
          ...
          <div class="mt-2">
            <div class="p-4 bg-red-50 border border-red-200 rounded-lg">
              <div class="flex items-center">
                ...
                <button on:click={() => clearFieldError('email')} class="ml-auto text-red-400 hover:text-red-600">
                  ✕
                </button>
              </div>
            </div>
          ...
          <div class="mt-2">
            <div class="p-4 bg-red-50 border border-red-200 rounded-lg">
              <div class="flex items-center">
                ...
                <button on:click={() => clearFieldError('password')} class="ml-auto text-red-400 hover:text-red-600">
                  ✕
                </button>
              </div>
            </div>
      ...
      <div class="mt-4">
        <div class="p-4 bg-red-50 border border-red-200 rounded-lg">
          <div class="flex items-center">
            ...
            <button on:click={clearGeneralError} class="text-red-400 hover:text-red-600">
              ✕
            </button>
          </div>
        </div>
